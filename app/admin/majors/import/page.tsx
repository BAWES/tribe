  ...
  return (
    <div className="container px-4 md:px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold mb-1">Import Majors</h1>
          <p className="text-zinc-400">Bulk import majors from a CSV file</p>
        </div>
      </div>
      ...
      <Card className="bg-white/5 border-white/10">
        <CardHeader>
          ...
          <CardDescription className="text-zinc-400">
            The CSV file should include columns for name, code, department, credit hours, and other major details
          </CardDescription>
        </CardHeader>
